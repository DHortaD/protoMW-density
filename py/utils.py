...
def generate_isogrid_new(mag=None):
    zs = np.arange(0.0005,0.0605, 0.0005)
    base = os.environ['ISODIST_DATA']
    isoname = 'parsec1.2-'
    if mag is None:
        mag = '2mass-spitzer-wise'
    isolist = []
    for i in tqdm.tqdm(range(len(zs))): 
        file = os.path.join(base,isoname+mag,isoname+mag+'-Z-%5.4f.dat.gz' % zs[i])
        alliso = np.genfromtxt(file, dtype=None, names=True, skip_header=11)
...
def APOGEE_iso_samples(nsamples, rec, fehrange=[-2.5,0], lowfehgrid = True):
    """
    ...
    mask = (trec[jkey]-trec[kkey] > 0.5)  & (Z2FEH(trec[zkey]) > fehrange[0]) & (Z2FEH(trec[zkey]) < fehrange[1]) & (trec[mkey] > 0.75) & (trec['logg'] > 0.5) & (trec['logg'] < 3.5) & (trec[logagekey] >= 10.) & ((10**trec[teff]) < 5500.) & ((10**trec[teff]) > 4000.)
    niso = sampleiso(nsamples, trec[mask], return_iso=True, lowfeh=lowfehgrid)
    mask = (trec[jkey]-trec[kkey] > 0.3001)  & (Z2FEH(trec[zkey]) > fehrange[0]) & (Z2FEH(trec[zkey]) < fehrange[1]) & (trec[mkey] > 0.75) & (trec['logg'] > 0.5) & (trec['logg'] < 3.5) & (trec[logagekey] >= 10.) & ((10**trec[teff]) < 5500.) & ((10**trec[teff]) > 4000.)
...
def check_prior(densfunc, params):
    ...
    if densfunc is densprofiles.spherical:
        ...
        elif params[1] < 0.01:return False
        elif params[1] > 1.:return False
        else: return True
    elif densfunc is densprofiles.triaxial:
        if params[0] < 0.1:return False
        elif params[0] > 10.:return False
        elif params[1] < 0.01:return False
        elif params[1] > 1.:return False
        elif params[2] < 0.01:return False
        elif params[2] > 1.:return False
        else: return True
    elif densfunc is densprofiles.justexpdisk:
        if params[0] < 0.01:return False
        elif params[0] > 10.:return False
        elif params[1] < 0.01:return False
        elif params[1] > 10.:return False
#         elif params[1] > 500.:return False  
        else: return True
    elif densfunc is densprofiles.justexpdisk_fixed:
        return True
    elif densfunc is densprofiles.plummer:
        if params[0] < 0.1:return False
        elif params[0] > 50.:return False
        else: return True
    elif densfunc is densprofiles.hernquist:
        if params[0] < 0.1:return False
        elif params[0] > 50.:return False
        else: return True
    elif densfunc is densprofiles.sersic:
        if params[0] < 0.01:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.01:return False
        elif params[1] > 30.:return False
        elif params[2] < 0.1:return False
        elif params[2] > 50.:return False
        else: return True
    elif densfunc is densprofiles.plummer_disc:
        if params[0] < 0.1:return False
        elif params[0] > 50.:return False
        elif params[1] < 0.:return False
        elif params[1] > 1.:return False
        else: return True
    elif densfunc is densprofiles.plummer_axi:
        if params[0] < 0.1:return False
        elif params[0] > 50.:return False
        elif params[1] < 0.:return False
        elif params[1] > 1.:return False
    ...
    elif densfunc is densprofiles.hernquist_axi:
        if params[0] < 0.1:return False
        elif params[0] > 50.:return False
        elif params[1] < 0.:return False
        elif params[1] > 1.:return False
    ...
    elif densfunc is densprofiles.sersic_axi:
        if params[0] < 0.01:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.01:return False
        elif params[1] > 30.:return False
    ...
    elif densfunc is densprofiles.hernquist_disc:
        if params[0] < 0.1:return False
        elif params[0] > 50.:return False
        elif params[1] < 0.:return False
        elif params[1] > 1.:return False
        else: return True
    elif densfunc is densprofiles.sersic_disc:
        if params[0] < 0.01:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.01:return False
        elif params[1] > 30.:return False
    ...
    elif densfunc is densprofiles.einasto:
        if params[0] < 0.:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 40.:return False  
        else: return True
    elif densfunc is densprofiles.einasto_geshalo:
        if params[0] < 0.:return False
    ...
    elif densfunc is densprofiles.einasto_expdisc:
        if params[0] < 0.:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 40.:return False
    ...
    elif densfunc is densprofiles.einasto_cutoff:
        if params[0] < 0.:return False
        elif params[0] > 100.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 500.:return False
        elif params[2] < 0.01: return False
        elif params[2] > 100: return False   
        else: return True
    elif densfunc is densprofiles.cored_powerlaw:
        if params[0] < 0.:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 50.:return False 
        else: return True
    elif densfunc is densprofiles.cored_powerlaw_axi:
        if params[0] < 0.:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 50.:return False 
    ...
    elif densfunc is densprofiles.cored_powerlaw_plusexpdisc:
        if params[0] < 0.:return False
        elif params[0] > 30.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 50.:return False 
    ...
    elif densfunc is densprofiles.einasto_expdisc_cutoff:
        if params[0] < 0.:return False
        elif params[0] > 100.:return False
        elif params[1] < 0.1:return False
        elif params[1] > 500.:return False
    ...
    elif densfunc is densprofiles.spl_pw:
        if params[0] < 0.:return False
        elif params[1] < 0.:return False
        elif params[1] > 1.:return False
        elif params[2] < 0.:return False
        ...
        elif params[3] >= 2*np.pi:return False
        elif params[4] <= 0.:return False
        elif params[4] >= 2*np.pi:return False
        elif params[5] <= 0.:return False
        elif params[5] >= 2*np.pi:return False
        elif params[6] < 0.:return False
        elif params[6] > 1.:return False
        else: return True
    elif densfunc is densprofiles.spl_pw_cutoff:
        if params[0] < 0.:return False
        elif params[1] < 0.:return False
        elif params[1] > 1.:return False
        elif params[2] < 0.:return False
    ...
    elif densfunc is densprofiles.broken:
        if params[0] < 0.:return False
        elif params[0] > 10.:return False
        elif params[1] < 0.:return False
        elif params[1] > 10.:return False
    ...
    elif densfunc is densprofiles.broken_pw:
        if params[0] < 0.:return False
        elif params[0] > 10.:return False
        elif params[1] < 0.:return False
        elif params[1] > 10.:return False
        ...
        elif params[6] >= 2*np.pi:return False
        elif params[7] <= 0.:return False
        elif params[7] >= 2*np.pi:return False
        elif params[8] <= 0.:return False
        elif params[8] >= 1.:return False
        else: return True
    elif densfunc is densprofiles.broken_pw_cutoff:
        if params[0] < 0.:return False
        elif params[0] > 10.:return False
        elif params[1] < 0.:return False
        elif params[1] > 10.:return False
        ...
        elif params[9] <= 0.:return False
        elif params[9] >= 100.:return False
        else: return True        
    elif densfunc is densprofiles.broken_pw_nodisc:
        if params[0] < 0.:return False
        elif params[0] > 10.:return False
        elif params[1] < 0.:return False
        elif params[1] > 10.:return False
    ...
    elif densfunc is densprofiles.triple_pw:
        if params[0] < 1.:return False
        elif params[0] > 3.:return False
        elif params[1] < 2.:return False
        elif params[1] > 5.:return False       
        elif params[2] < 3.:return False
        elif params[2] > 6.:return False
        elif params[3] < 1.:return False
        elif params[3] > 10.:return False
        elif params[4] < 10.:return False
        elif params[4] > 30.:return False
        elif params[5] < 0.:return False
        ...
        elif params[8] >= 2*np.pi:return False
        elif params[9] <= 0.:return False
        elif params[9] >= 2*np.pi:return False
        elif params[10] < 0.:return False
        elif params[10] > 1.:return False
        else: return True
#     elif densfunc is densprofiles.einasto_simple:
#         if params[0] < 0.5:return False
#         if params[0] > 30.:return False
# #         elif params[1] < 0.:return False
# #         elif params[1] > 200.:return False
#         elif params[1] < 0.:return False
#         elif params[1] > 5.:return False
#         elif params[2] < 0.:return False
#         elif params[2] > 5.:return False
#         else: return True
#     elif densfunc is densprofiles.einasto_rot:
#         if params[0] < 0.5:return False
#         if params[0] > 30.:return False
#         elif params[1] < 0.:return False
#         elif params[1] > 100.:return False
#         elif params[2] < 0.:return False
#         elif params[2] > 1.:return False
#         elif params[3] < 0.:return False
#         elif params[3] > 1.:return False
...
#         else: return True
    ...
    elif densfunc is densprofiles.triaxial_einasto:
        if params[0] < 0.:return False
        if params[1] < 0.01:return False
        elif params[2] < 0.1:return False
        elif params[2] > 1.:return False
